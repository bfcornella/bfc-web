      ...
      <nav className='uk-navbar-container uk-background-primary uk-navbar uk-visible@s'>
                  ...
                  <li key={category.id}>
                    {category.attributes.subcategories.data.length == 0 && (
                      <Link
                        ...
                        href={category.attributes.slug == 'home' ? `/` : `/category/${category.attributes.slug}`}
                      >
        ...
        <div className='uk-navbar-right uk-margin-large-right'>
          <div className='uk-navbar-nav'>
            <button className='uk-button uk-button-small uk-button-secondary uk-margin-small-right'>
              <a href='https://www.basquetcatala.cat/club/192'>Federació Catalana BQ</a>
            </button>
            <button className='uk-button uk-button-default'>
              <a href='https://app.basquetfemenicornella.com'>ACCÉS APP</a>
            </button>
          </div>
        </div>
      </nav>
      ...
      <nav className='uk-navbar-container-tight uk-background-primary uk-navbar uk-hidden@s'>
        <div className='uk-child-width-1-2 uk-child-height-1-2 uk-grid'>
          ...
          <div className='uk-position-top-right'>
            <a
              href='#'
              className='uk-navbar-toggle uk-navbar-toggle-animate uk-position-right uk-padding uk-margin-top uk-hidden@s'
              uk-toggle='target: #sidenav'
            >
              <svg className='uk-navbar-toggle-animate' fill='white' width='30' height='30' viewBox='0 0 20 20'>
